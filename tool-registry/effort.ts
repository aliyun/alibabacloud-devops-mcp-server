...
export const getEffortTools = () => [
  {
    ...
    inputSchema: toInputSchema(ListCurrentUserEffortRecordsSchema),
  },
  {
    name: "list_effort_records",
    description: "[Project Management] 获取实际工时明细",
    inputSchema: toInputSchema(ListEffortRecordsSchema),
  },
  {
    ...
    inputSchema: toInputSchema(CreateEffortRecordSchema),
  },
  {
    name: "list_estimated_efforts",
    description: "[Project Management] 获取预计工时明细",
    inputSchema: toInputSchema(ListEstimatedEffortsSchema),
  },
  {
