...
export const getProjectManagementTools = () => [
  // Project Operations
  {
    ...
    inputSchema: toInputSchema(types.GetProjectSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.SearchProjectsSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.SearchProgramsSchema),
  },
  ...
  // Version Operations
  {
    ...
    inputSchema: toInputSchema(types.ListProgramVersionsSchema),
  },
  {
    name: "list_versions",
    ...
    inputSchema: toInputSchema(types.ListVersionsSchema),
  },
  {
    name: "create_version",
    ...
    inputSchema: toInputSchema(types.CreateVersionSchema),
  },
  {
    name: "update_version",
    ...
    inputSchema: toInputSchema(types.UpdateVersionSchema),
  },
  {
    name: "delete_version",
    description: "[Project Management] Delete a version from a Yunxiao Project.\n\nUse Cases:\n\nRemove obsolete versions\nClean up project versions",
    inputSchema: toInputSchema(types.DeleteVersionSchema),
  },
  ...
  // Sprint Operations
  {
    ...
    inputSchema: toInputSchema(types.GetSprintSchema),
  },
  {
    name: "list_sprints",
    description: "[Project Management] List sprints in a project",
    inputSchema: toInputSchema(types.ListSprintsSchema),
  },
  {
    name: "create_sprint",
    description: "[Project Management] Create a new sprint",
    inputSchema: toInputSchema(types.CreateSprintSchema),
  },
  {
    name: "update_sprint",
    description: "[Project Management] Update an existing sprint",
    inputSchema: toInputSchema(types.UpdateSprintSchema),
  },
  ...
  // Work Item Operations
  {
    ...
    inputSchema: toInputSchema(types.GetWorkItemSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.CreateWorkItemSchema),
  },
  {
  ...
  },
  {
    ...
    inputSchema: toInputSchema(types.DeleteWorkItemSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.UpdateWorkItemSchema),
  },
  ...
  },
  {
    ...
    description: "[Project Management] List relation records of the requested relation type for a work item.",
    inputSchema: toInputSchema(types.ListWorkitemRelationRecordsSchema),
  },
  {
    name: "create_workitem_relation_record",
    description: "[Project Management] Relate one work item to another. Use ASSOCIATED for a normal related item without a parent-child hierarchy.",
    inputSchema: toInputSchema(types.CreateWorkitemRelationRecordSchema),
  },
  {
    name: "delete_workitem_relation_record",
    description: "[Project Management] Delete a relation between two work items without deleting either work item.",
  ...
  // Work item related testcase Operations
  {
    ...
    inputSchema: toInputSchema(types.ListWorkitemTestcaseRelationsSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.CreateWorkitemTestcaseRelationSchema),
  },
  {
    ...
    inputSchema: toInputSchema(types.DeleteWorkitemTestcaseRelationSchema),
    annotations: {
      destructiveHint: true,
    },
  },
  ...
  // Attachment Operations
  {
    ...
    inputSchema: toInputSchema(types.ListWorkitemAttachmentsSchema),
  },
  {
  ...
  },
  {
    ...
    inputSchema: toInputSchema(types.ListWorkitemActivitiesSchema),
  }
];
