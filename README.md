...
- `create_workitem_relation_record`: Relate one work item to another; use `ASSOCIATED` for a normal related item
- `delete_workitem_relation_record`: Delete a work item relation record
